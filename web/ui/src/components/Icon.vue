...
<script setup>
/**
 * 极简图标 —— Lucide 风格的 24×24 线条图标。
 *
 * 用 SVG 而非 emoji 的原因：
 * - emoji 在各系统渲染差异巨大（Win / mac / Linux 三套），产品级 UI 不能赌
 * - 线条色 / 描边粗 / 尺寸 token 化后能跟着主题变
 * - 文字旁图标的灰阶一致，全靠统一描边宽度
 *
 * 一组常用的就够 —— 多写不如引入一个图标库（lucide-vue-next）。
 */
...
const SIZE_MAP = { sm: 14, md: 16, lg: 20 };
const dim = computed(() => SIZE_MAP[props.size] || 16);

/** Lucide 24×24 line icons. 全部 stroke="currentColor" 所以颜色走父级. */
const PATHS = {
  // 创作四件套
  clone: '<rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>',
  design: '<circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m3.08 3.08l4.24 4.24M1 12h6m6 0h6M4.22 19.78l4.24-4.24m3.08-3.08l4.24-4.24"/>',
  dialogue: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',
  suno: '<circle cx="12" cy="12" r="10"/><path d="M9 18V5l12 7-12 7z" fill="currentColor"/>',
  // 工作区
  ...
  publish: '<path d="M22 2L11 13"/><path d="M22 2l-7 20-4-9-9-4 20-7z"/>',
  library: '<path d="M3 3h18v18H3z"/><path d="M3 9h18M9 21V9"/>',
  // 音色
  ...
  expand: '<polyline points="9 21 9 15 3 15"/><polyline points="15 3 15 9 21 9"/><line x1="21" y1="3" x2="15" y2="9"/><line x1="3" y1="21" x2="9" y2="15"/>',
  ...
  sparkles: '<path d="M12 3v3m0 12v3M5.6 5.6l2.1 2.1m8.6 8.6l2.1 2.1M3 12h3m12 0h3M5.6 18.4l2.1-2.1m8.6-8.6l2.1-2.1"/>',
  warning: '<path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  info: '<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>',
  pulse: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>',
  wallet: '<path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4z"/>',
  // 表单标签用的一组。老屏幕（克隆/设计/剧本/AI 音乐）的表单标签原本
  // 全是 emoji，和这个组件存在的理由直接冲突（见文件头：emoji 在三套系统
  // 上渲染完全不同、不能跟主题变色）。补齐这几个之后就能一次换净。
  user: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  folder: '<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>',
  music: '<path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/>',
  speech: '<path d="M3 11a9 9 0 0 1 9-9v0a9 9 0 0 1 9 9v0a9 9 0 0 1-9 9H7l-4 3z"/><path d="M8 11h.01M12 11h.01M16 11h.01"/>',
  mask: '<path d="M4 5h16v6a8 8 0 0 1-8 8 8 8 0 0 1-8-8z"/><path d="M9 11h.01M15 11h.01"/><path d="M9 15c1 1 5 1 6 0"/>',
  ...
  flame: '<path d="M12 2c3 4 5 6.5 5 9.5A5 5 0 0 1 7 11.5C7 8.5 9 6 12 2z"/>',
